...
class GetBlockChainInfo:
    def __init__(self, get_or_load=0):
        ##########################################
        ...
        while True:
            if get_or_load == 0:
                get_or_load = float(input("Download new data from blockchain.com (Option no.: 1) or load downloaded, local saved data (Option no.: 2): "))
            if get_or_load == 1:
